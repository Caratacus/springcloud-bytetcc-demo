...
public class MybatisPlusConfig {
    ...
    public DataSource dataSource(@Autowired TransactionManagerImpl transactionManager) {
        ...
        hikariDataSource.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/auth?tinyInt1isBit=false&characterEncoding=utf8");
        hikariDataSource.setAutoCommit(false);
        localXADataSource.setDataSource(hikariDataSource);
